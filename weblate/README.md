...
```
To use the glossary file in OmegaT, copy the resulting CSV file to OmegaT's working directory (the 'glossary' subdirectory). It is necessary to change the suffix of the file to .txt.
